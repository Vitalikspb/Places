...
class WorldInteractor: WorldBussinessLogic, WorldDataStore {
    ...
    var rentsService = WorldViewModels.AllCountriesInTheWorld.ViewModel(model: [
        WorldViewModels.WorldViewModel(titlesec: WorldViewModels.TitleSection(name: "Россия", subName: "12 городов, 954 интересных мест"),items: [
        ...
        WorldViewModels.WorldViewModel(titlesec: WorldViewModels.TitleSection(name: "Франция", subName: "17 городов, 1042 интересных мест"),items: [
        ...
        WorldViewModels.WorldViewModel(titlesec: WorldViewModels.TitleSection(name: "США", subName: "18 городов, 1373 интересных мест"),items: [
