//
//  ChoiseRedactionCellsCitiesCollectionViewCell.swift
//  TabBarTest
//
...
class ChoiseRedactionCellsCitiesCollectionViewCell: UICollectionViewCell {
    
    // MARK: - Public properties
    
    static let identifier = "ChoiseRedactionCellsCitiesCollectionViewCell"
