//
//  ParksCellsCitiesCollectionViewCell.swift
//  TabBarTest
//
...
class ParksCellsCitiesCollectionViewCell: UICollectionViewCell {
    
    // MARK: - Public properties
    
    static let identifier = "ParksCellsCitiesCollectionViewCell"
