...
class MuseumsTableViewCell: UITableViewCell {
    ...
    static let identifier = "MuseumsTableViewCell"
    ...
    private func setupUI() {
        ...
        collectionView.register(MuseumsCellsCitiesCollectionViewCell.self,
                                forCellWithReuseIdentifier: MuseumsCellsCitiesCollectionViewCell.identifier)
...
extension MuseumsTableViewCell: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: MuseumsCellsCitiesCollectionViewCell.identifier, for: indexPath) as? MuseumsCellsCitiesCollectionViewCell else { return UICollectionViewCell() }
