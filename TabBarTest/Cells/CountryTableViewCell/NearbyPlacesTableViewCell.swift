...
class NearbyPlacesTableViewCell: UITableViewCell {
    ...
    private let titleLabel: UILabel = {
       let label = UILabel()
        ...
        label.text = "Места в окрестностях"
        return label
    }()
    ...
    static let identifier = "NearbyPlacesTableViewCell"
    ...
    private func setupUI() {
        ...
        collectionView.register(NearbyPlacesCellsCitiesCollectionViewCell.self,
                                forCellWithReuseIdentifier: NearbyPlacesCellsCitiesCollectionViewCell.identifier)
...
extension NearbyPlacesTableViewCell: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: NearbyPlacesCellsCitiesCollectionViewCell.identifier, for: indexPath) as? NearbyPlacesCellsCitiesCollectionViewCell else { return UICollectionViewCell() }
