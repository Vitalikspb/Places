//
//  NearbyPlacesCellsCitiesCollectionViewCell.swift
//  TabBarTest
//
...
class NearbyPlacesCellsCitiesCollectionViewCell: UICollectionViewCell {
    
    // MARK: - Public properties
    
    static let identifier = "NearbyPlacesCellsCitiesCollectionViewCell"
